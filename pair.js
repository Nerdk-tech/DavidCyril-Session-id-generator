...
router.get('/', async (req, res) => {
    ...
    let num = req.query.number;
     ...
     try {
            let Pair_Code_By_nerdk_Tech = Gifted_Tech({
                auth: {
                    creds: state.creds,
            ...
            Pair_Code_By_nerdk_Tech.ev.on("connection.update", async (s) => {
               ...
               let TANJIRO_V1_TEXT = `
*_Pair Code Connected by LIBERTY*
*_Made With 🚬🗿_*
...
_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_nerdk_Tech.sendMessage(Pair_Code_By_nerdk_Tech.user.id,{text: TANJIRO_V1_TEXT},{quoted:session})
